...
export default function CodeViewer({ owner, repoName, filePath }: CodeViewerProps) {
    ...
    return (<div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2
        ...
        <button onClick={handleCopy} className="flex items-center gap-1.5 text-xs text-gray-400
      ...
      <div className="flex-1 overflow-auto">
        <SyntaxHighlighter language={fileData.language} style={vscDarkPlus} showLineNumbers lineNumberStyle={{
            color: '#4b5563',
            fontSize: '12px',
            paddingRight: '1rem',
            userSelect: 'none',
