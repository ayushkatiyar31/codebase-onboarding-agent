...
export const FileTreeSkeleton = () => (
  <div className="p-3 flex flex-col gap-1.5" aria-label="Loading file tree...">
    {[
...
export const RepoHeaderSkeleton = () => (
  <div
    className="border-b border-gray-800 px-6 py-4 flex items-center gap-6"
    aria-label="Loading repository info..."
  >
...
export const ArchitectureSkeleton = () => (
  <div
    ...
    aria-label="Loading architecture analysis..."
  >
    <Skeleton className="h-5 w-48 rounded" />
...
export const CodeViewerSkeleton = () => (
  <div className="flex flex-col h-full" aria-label="Loading file contents...">
